<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adCentros.aspx.cs" Inherits="Presentacion.adCentros1" %>
...
<asp:Content ID="Content3"  ContentPlaceHolderID="Main" runat="server">
   ...
   <asp:Label ID="lblSuccess" runat="server" CssClass="label label-success center-block" Visible="false" Text=" "></asp:Label>
 ...
 <asp:Button ID="btbAgregarr" runat="server" CssClass="btn btn-success pull-left" 
            Text="AGREGAR CENTRO" onclick="btbAgregarr_Click" 
             />
