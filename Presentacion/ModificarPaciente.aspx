<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarPaciente.aspx.cs" Inherits="Presentacion.ModificarPaciente" %>
...
<div class="form-group">
    ...
    <asp:TextBox ID="txtApellido" required = "true" style="text-align:center" CssClass="form-control" runat="server"></asp:TextBox>
</div>
<div class="form-group">
    <asp:Label ID="Label4" runat="server" CssClass="label label-info center-block" Font-Size="15px"  Text="Edad"></asp:Label>
    <asp:TextBox ID="txtEdad" required = "true" style="text-align:center" CssClass="form-control" TextMode="Number" runat="server"></asp:TextBox>
</div>
