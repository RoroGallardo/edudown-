<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aBox.aspx.cs" Inherits="Presentacion.aBox" %>
...
<body>
    ...
    <div>
     <div class="col-md-9" id="editPanel">
       ...
       <div class="row" >
        ...
        <div class="form-group col-md-5">
        <asp:Label ID="lblDire" runat="server" CssClass="label label-info center-block" Font-Size="15px" Text="TIPO"></asp:Label>
   ...
   <div class="col-md-3">
        ...
        <asp:Button ID="btnGuardar" CssClass="btn btn-success center-block"   runat="server" 
            Text="GUARDAR " onclick="btnAgregar_Click" /> <br>
