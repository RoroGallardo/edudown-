<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarFicha.aspx.cs" Inherits="Presentacion.AgregarFicha" %>
...
<div class="form-group">
    ...
    <asp:TextBox ID="txtRut" required = "true" style="text-align:center"  CssClass="form-control" required ="" runat="server"></asp:TextBox>
</div>
<div class="form-group">
...
<div>
    <asp:Button ID="Button1" runat="server" 
        CssClass="btn btn-success center-block" Text="AGREGAR FICHA" 
